...
{
    type = "item",
    icon = "__planet-rabbasca__/graphics/by-hurricane/gravity-assembler-icon.png",
...
{
    type = "item",
    icon = "__planet-rabbasca__/graphics/recolor/icons/harenic-stabilizer.png",
...
{
    type = "item",
    icon = "__planet-rabbasca__/graphics/recolor/icons/harene-ears-core.png",
...
},
{
    type = "item",
    icons = {
      { icon = "__planet-rabbasca__/graphics/recolor/icons/harene-ears-core.png", scale = 0.5, shift = { -8, 0 } },
      { icon = "__planet-rabbasca__/graphics/recolor/icons/harene-ears-core.png", scale = 0.5 },
      { icon = "__planet-rabbasca__/graphics/recolor/icons/harene-ears-core.png", scale = 0.5, shift = { 8, 0 } },
    },
...
util.merge {
  ...
  util.merge {
    table.deepcopy(data.raw["capsule"]["raw-fish"]),
    {
      ...
      icon = "__planet-rabbasca__/graphics/recolor/icons/protein-shake.png",
      spoil_ticks = 0,
      spoil_result = nil,
      weight = 20 * kg,
...
util.merge { data.raw["item"]["rocket-fuel"],
{
  ...
  icon = "__planet-rabbasca__/graphics/recolor/icons/turbofuel.png",
  fuel_value = "220MJ",
...
{
    type = "item",
    icon = "__planet-rabbasca__/graphics/recolor/icons/carotenoid.png",
    name = "carotenoid-ore",
    stack_size = 5,
    weight = 100 * kg,
    subgroup = "rabbasca-processes",
...
},
{
    type = "item",
    icons = {
      { icon = "__planet-rabbasca__/graphics/recolor/icons/harene-gas.png" },
...
},
{
  type = "fluid",
    name = "harene",
    icon = "__planet-rabbasca__/graphics/recolor/icons/harene.png",
    subgroup = "fluid",
...
},
{
    type = "fluid",
    name = "beta-carotene",
    icon = "__planet-rabbasca__/graphics/recolor/icons/beta-carotene.png",
    subgroup = "fluid",
...
},
{
    ...
    icon = "__planet-rabbasca__/graphics/recolor/icons/energetic-residue.png",
    subgroup = "fluid",
...
util.merge { data.raw["tool"]["automation-science-pack"], {
  ...
  icon = "__planet-rabbasca__/graphics/recolor/icons/athletic-science-pack.png",
  order = "j-r[rabbasca]",
  weight = 0.1 * kg,
  stack_size = 500
}},
