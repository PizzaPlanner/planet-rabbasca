  ...
  },
{
    ...
    expression = "max(\z
                    starting_spot_at_angle{angle = map_seed,       distance = 70, radius = 14, x_distortion = 0, y_distortion = 0},\z
                    starting_spot_at_angle{angle = map_seed + 143, distance = 65, radius = 17, x_distortion = 0, y_distortion = 0}) * 0.8\z 
                  + 0.25 * multioctave_noise{x = x, y = y, persistence = 0.57, seed0 = map_seed, seed1 = 'whatsupnextbro', input_scale = 0.5, output_scale = 0.3, octaves = 2 }"
  },
  {
    type = "noise-expression",
